...
from RCCC_utils.gen_index_dataset import gen_index_dataset
...
def PLL_prepare_train_loaders_for_uniform_cv_candidate_labels(
...
def prepare_cv_datasets(dataname, batch_size):
    if dataname == "mnist":
        ordinary_train_dataset = dsets.MNIST(
            root="/home/guzeng/Data/myresearch/IJCNN23/data/mnist",
            train=True,
        ...
        ordinary_train_dataset = dsets.KMNIST(
            root="./data/KMNIST",
            train=True,
            transform=transforms.ToTensor(),
            download=True,
        ...
        test_dataset = dsets.KMNIST(
            root="/home/guzeng/Data/myresearch/IJCNN23/data/KMNIST",
            train=False,
            transform=transforms.ToTensor(),
        )
        ...
        test_dataset = dsets.FashionMNIST(
            root="/home/guzeng/Data/myresearch/IJCNN23/data/FashionMnist",
            train=False,
            transform=transforms.ToTensor(),
        )
...
def prepare_train_loaders_for_uniform_cv_candidate_labels(
    dataname, full_train_loader, batch_size
):
